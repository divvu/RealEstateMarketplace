...
contract Ownable {
    ...
    modifier onlyOwner() {
      require(_owner == msg.sender, 'Caller is not the contract owner');
      _;
    }
...
modifier whenNotPaused{
  require(!_paused, "Contract is currently not paused");
  _;
}
modifier paused {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to == ownerOf(tokenId), "Cannot approve to yourself");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        // HERE
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender), "Caller is not authorized against this token");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId) == false, "Token exists already");
        // HERE
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Only token owner can perform this");
